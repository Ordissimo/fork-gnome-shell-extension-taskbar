...
var UserIndicator = new Lang.Class({
    ...
    _init: function () {
        ...
        this._power_gicon = Gio.icon_new_for_string(`${Me.path}/images/system-shutdown-symbolic.svg`);
    ...
    _createSubMenu: function () {
        ...
        this._switchuser_gicon = Gio.icon_new_for_string(`${Me.path}/images/switch-user-symbolic.svg`);
        ...
        this._orientation_icon_gicon = Gio.icon_new_for_string(`${Me.path}/images/orientation-lock-symbolic.svg`);
