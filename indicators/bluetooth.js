...
var BluetoothIndicator = new Lang.Class({
    ...
    _init: function () {
        ...
        this._bluetooth_active_gicon = Gio.icon_new_for_string(`${Me.path}/images/bluetooth-active-symbolic.svg`);
        this._bluetooth_disabled_gicon = Gio.icon_new_for_string(`${Me.path}/images/bluetooth-disabled-symbolic.svg`);
        this._bluetooth_paired_gicon = Gio.icon_new_for_string(`${Me.path}/images/bluetooth-paired-symbolic.svg`);
